...
public class CallTestService extends PersistentService implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static String STOP_BUTTON = CallTestService.class.getCanonicalName() + ".STOP_BUTTON";
    ...
    public static boolean isEnabled(Context context) {
        ...
        if (!Storage.permitted(context, CallTestActivity.MUST))
            b = false;
        return b;
    }
   ...
   @Override
    ...
    public Notification buildPersistent(Notification when) {
        PendingIntent main = PendingIntent.getActivity(this, 0, new Intent(this, CallTestActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void updateIcon(boolean show) {
        boolean recording = thread != null;
        CallTestActivity.showProgress(CallTestService.this, show, phone, samplesTime / sampleRate, recording);
            ...
            public void run() {
                ...
                Runnable save = new Runnable() {
                    ...
                    public void run() {
                        ...
                        CallTestActivity.last(CallTestService.this);
                    ...
                    while (!interrupt.get()) {
                        ...
                        if (stableRefresh || diff >= samples) {
                            ...
                            if (samplesTimeCount > samplesTimeUpdate) {
                                ...
                                CallTestActivity.showProgress(CallTestService.this, true, phone, samplesTime / sampleRate, true);
                            }
                        }
                    }
    ...
    void encoding(final File in, final Uri uri, final Runnable done, final Success success) {
        ...
        final Runnable save = new Runnable() {
            ...
            public void run() {
                ...
                CallTestActivity.showProgress(CallTestService.this, false, phone, samplesTime / sampleRate, false);
        ...
        encoder.run(new Runnable() {
            ...
            public void run() {  // progress
                CallTestActivity.setProgress(CallTestService.this, encoder.getProgress());
            }
        }, new Runnable() {
            @Override
    ...
    void pauseButton() {
        if (thread != null)
            ...
            startRecording();
        CallTestActivity.showProgress(this, true, phone, samplesTime / sampleRate, thread != null);
    }
