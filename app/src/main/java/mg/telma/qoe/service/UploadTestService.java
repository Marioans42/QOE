...
import static mg.telma.qoe.service.UploadTestService.uploadedKByte;


public class UploadTestService extends Thread{
    ...
    public UploadTestService(String fileURL) {
